    ...
    if(entries.length == 0){
        return(
            <div className='dark:bg-black h-screen'>
                <section>
                    <h1 className="dark:text-white text-center font-semibold text-2xl p-5">You don't have any cards</h1>
                    <p className="dark:text-white text-center font-medium text-md">Lets <Link className="text-blue-400 underline underline-offset-1" to="/create">Create One</Link></p>
                </section>
            </div>
        )
    }
                    ...
                    return(
                        <div id={entry.id} key={index}className="bg-gray-300 shadow-md shadow-gray-500 m-3 p-4 rounded flex flex-col justify-between">
                            ...
                            <section className="flex items-center justify-between flex-col pt-2 md:pt-0">
                                {/* Changed - added time div, switched order and removed flex row */}
                                <div>
